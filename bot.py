...
"options": ["في الجمجمة","في تجويف البطن",""],
...
"options": ["طبقة تغطي الدماغ","طبقة ليفية تغطي جسم العظم الطويل ✅",""],
...
"options": ["بين جسم العظم ومشاشيته ✅","داخل القحف",""],
...
"options": ["خلف وأسفل المخ ✅","داخل النخاع الشوكي",""],
...
"options": ["داخل القحف الأمامي فقط","فوق المخ",""],
...
"options": ["في النخاع الشوكي","في المخيخ",""],
...
"options": ["في جذع الدماغ","صفيحة بيضاء تحت الجسم الثفني ✅",""],
...
"options": ["في مركز المادة الرمادية للنخاع الشوكي ✅","في المخيخ",""],
...
"options": ["بين غشاء العنكبوتي والأم الحنون (يحتوي السائل الخارجي) ✅","داخل العظام",""],
...
"options": ["في الفص الصدغي","في الفص القفوي",""],
...
"options": ["في المخيخ","في الفص الجبهي",""],
...
"options": ["في الفص الجبهي","في النخاع الشوكي",""],
...
"options": ["على الجذر الأمامي الحركي","داخل الدماغ",""],
...
"options": ["تحيط بالحنجرة وأعلى الرغامي ✅","في الدماغ",""],
...
"options": ["أربع غدد تلتصق بالسطح الخلفي للغدة الدرقية ✅","في القلب",""],
...
"options": ["داخل المثانة","في الرقبة",""],
...
"options": ["في المعدة","تقع داخل الدماغ ✅",""],
...
"options": ["1- السمحاق، 2- نسيج عظمي كثيف، 3- قناة مركزية","2- نسيج عظمي كثيف، 1- السمحاق، 3- قناة مركزية","3- قناة مركزية، 2- نسيج عظمي كثيف، 1- السمحاق"],
