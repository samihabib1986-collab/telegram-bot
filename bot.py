...
subjects = {
    "bio": {
        ...
        "u1_dam_taaleel": [
            {
"question": "1. لماذا توجد اليافوخات (فتحات عظمية) في جمجمة الرضيع؟",
"options": ["لحماية الدماغ من الصدمات الخارجية","✓ للسماح لعظام القحف بالنمو تماشياً مع نمو الدماغ","لتسهيل عملية التنفس لدى الرضيع"],
"answer": "✓ للسماح لعظام القحف بالنمو تماشياً مع نمو الدماغ"
},
{
"question": "2. لماذا تعمل الأقراص الغضروفية بين الفقرات كوسادة مرنة؟",
"options": ["لتسهيل مرور الأعصاب الشوكية","✓ لأنها تمنع احتكاك عظام الفقرات ببعضها وتتحمل الضغط","لزيادة طول العمود الفقري"],
"answer": "✓ لأنها تمنع احتكاك عظام الفقرات ببعضها وتتحمل الضغط"
},
{
"question": "3. لماذا يزداد طول رواد الفضاء بمعدل (2-5 سم) في الفضاء الخارجي؟",
"options": ["بسبب زيادة نشاط نقي العظم","✓ بسبب غياب الجاذبية مما يقلل الضغط على فقرات العمود الفقري","بسبب تمدد العضلات الطولية"],
"answer": "✓ بسبب غياب الجاذبية مما يقلل الضغط على فقرات العمود الفقري"
},
{
"question": "4. لماذا يمتاز العظم بالصلابة والقساوة والمتانة؟",
"options": ["بسبب كثرة الأوعية الدموية فيه","✓ بسبب الروابط الوثيقة بين الأملاح المعدنية والمواد العضوية","بسبب وجود السمحاق الذي يغطيه"],
...
"options": ["بسبب توقف انقسام خلايا السمحاق","✓ بسبب تعظم غضاريف النمو (الاتصال)","بسبب نقص أملاح الكالسيوم"],
"answer": "✓ بسبب تعظم غضاريف النمو (الاتصال)"
},
{
"question": "6. لماذا تسمى العضلات المخططة بالعضلات الهيكلية؟",
"options": ["لأنها توجد في جدران الأحشاء","✓ لأن معظمها يرتبط بعظام الهيكل العظمي","لأن حركتها تكون لاإرادية"],
"answer": "✓ لأن معظمها يرتبط بعظام الهيكل العظمي"
},
{
"question": "7. لماذا يبقى الرأس منتصباً في أثناء اليقظة دون بذل جهد؟",
...
"options": ["لأن حركتها بطيئة جداً","✓ لأن حركتها لا تخضع لإرادة الإنسان","لأنها لا ترتبط بالعظام"],
"answer": "✓ لأن حركتها لا تخضع لإرادة الإنسان"
},
{
"question": "9. لماذا تعتبر العظام مخزناً احتياطياً مهماً للجسم؟",
"options": ["لأنها تنتج كريات الدم الحمراء","✓ لأنها تختزن أملاح الكالسيوم الضرورية للجسم","لأنها تحمي الأحشاء الداخلية"],
"answer": "✓ لأنها تختزن أملاح الكالسيوم الضرورية للجسم"
},
{
"question": "10. لماذا توفر مفاصل القحف أقصى درجات الحماية للدماغ؟",
"options": ["لأنها مفاصل واسعة الحركة","✓ لأنها مفاصل ثابتة تلتحم بواسطة مسننات عظمية","لأنها محاطة بأوتار قوية"],
...
"options": ["تغطي جسم العظم من الخارج","✓ تقع بين جسم العظم والمشاشتين","توجد داخل القناة المركزية"],
"answer": "✓ تقع بين جسم العظم والمشاشتين"
},
{
"question": "2. حدد موقع النخاع الشوكي بالنسبة للهيكل العظمي:",
"options": ["داخل تجويف الجمجمة","✓ يسكن القناة الفقرية الناتجة عن تتالي الثقوب الفقرية","بين أضلاع القفص الصدري"],
"answer": "✓ يسكن القناة الفقرية الناتجة عن تتالي الثقوب الفقرية"
},
{
"question": "3. حدد موقع السمحاق في العظم الطويل:",
"options": ["يملأ فراغات المشاشتين","✓ طبقة رقيقة ليفية تغطي جسم العظم","يوجد داخل نقي العظم"],
"answer": "✓ طبقة رقيقة ليفية تغطي جسم العظم"
},
{
"question": "4. حدد موقع النسيج العظمي الإسفنجي في العظم الطويل:",
"options": ["يوجد في السطح الخارجي للجسم","✓ يوجد في المشاشتين (النهايتين المنتفختين)","يبطن القناة المركزية"],
"answer": "✓ يوجد في المشاشتين (النهايتين المنتفختين)"
},
{
"question": "5. حدد موقع عظم الرضفة في جسم الإنسان:",
"options": ["في مفصل المرفق","✓ في مفصل الركبة لمنع انثناء الساق للأمام","في مفصل العضد"],
"answer": "✓ في مفصل الركبة لمنع انثناء الساق للأمام"
},
{
"question": "6. حدد موقع نقي العظم الأحمر:",
"options": ["في السطح الخارجي للسمحاق","✓ يملأ فراغات النسيج العظمي الإسفنجي","يوجد في الأقراص الغضروفية"],
"answer": "✓ يملأ فراغات النسيج العظمي الإسفنجي"
},
{
"question": "7. حدد موقع العضلة الماصغة في جسم الإنسان:",
"options": ["في الناحية الخلفية للعضد","✓ تقع على جانبي الوجه وتغلق الفكين","توجد في جدار المعدة"],
"answer": "✓ تقع على جانبي الوجه وتغلق الفكين"
},
{
"question": "8. حدد موقع الزنار الكتفي في الهيكل الطرفي:",
"options": ["يربط الطرفين السفليين بالجذع","✓ يربط الطرفين العلويين بالجذع ويتألف من عظمي الترقوة ولوح الكتف","يوجد في عظام الرسغ"],
"answer": "✓ يربط الطرفين العلويين بالجذع ويتألف من عظمي الترقوة ولوح الكتف"
},
{
"question": "9. حدد موقع عظمة القص في الهيكل المحوري:",
"options": ["في الناحية الخلفية للجذع","✓ في الناحية الأمامية للقفص الصدري وترتبط بها الأضلاع","فوق عظم الفخذ مباشرة"],
"answer": "✓ في الناحية الأمامية للقفص الصدري وترتبط بها الأضلاع"
},
{
"question": "10. حدد موقع النسيج العظمي الكثيف في العظم الطويل:",
"options": ["يوجد في المشاشتين فقط","✓ طبقة تلي السمحاق وتشكل البنية الأساسية لجسم العظم","يوجد داخل غضاريف النمو"],
...
"options": ["النمو الطولي للعظم","✓ النمو العرضي للعظم","توقف نمو العظم نهائياً"],
...
"options": ["ترسيب أملاح الكالسيوم","✓ تكوين خلايا الدم (الكريات الحمراء والبيضاء والصفيحات)","التحام عظام القحف"],
"answer": "✓ تكوين خلايا الدم (الكريات الحمراء والبيضاء والصفيحات)"
},
{
"question": "6. ماذا ينتج عن تنبيه ليفة عضلية بمنبه ما؟",
"options": ["استرخاء العضلة","✓ تقلص العضلة واستجابتها للمنبه","تحولها إلى نسيج ليفي"],
"answer": "✓ تقلص العضلة واستجابتها للمنبه"
},
{
"question": "7. ماذا ينتج عن خاصية المرونة في العضلات؟",
"options": ["بقاء العضلة متقلصة دائماً","✓ عودة العضلة إلى وضعها الطبيعي بعد زوال التأثير عنها","تعب العضلة السريع"],
...
{
"question": "9. ماذا ينتج عن غياب الروابط بين الأملاح المعدنية والمادة العضوية في العظم؟",
"options": ["زيادة قوة العظم","✓ فقدان العظم لصلابته ومتانته","نمو العظم بشكل أسرع"],
"answer": "✓ فقدان العظم لصلابته ومتانته"
},
{
"question": "10. ماذا ينتج عن تقلص عضلات الرقبة بشكل مستمر وبسيط (المقوية العضلية)؟",
"options": ["التعب العضلي الشديد","✓ بقاء الرأس منتصباً في أثناء اليقظة","انحناء الرقبة نحو الأمام"],
"answer": "✓ بقاء الرأس منتصباً في أثناء اليقظة"
}
],
        "u1_dam_function": [{
"question": "1. ما هي وظيفة نقي العظم الأحمر؟",
"options": ["تخزين أملاح الكالسيوم فقط","✓ تكوين خلايا الدم (الكريات الحمراء والبيضاء والصفيحات)","إعطاء العظم اللون الأبيض"],
"answer": "✓ تكوين خلايا الدم (الكريات الحمراء والبيضاء والصفيحات)"
},
{
"question": "2. ما هي وظيفة السمحاق في العظم الطويل؟",
"options": ["المسؤول عن النمو الطولي للعظم","✓ المسؤول عن النمو العرضي للعظم (زيادة الثخانة)","حماية نقي العظم الأحمر"],
"answer": "✓ المسؤول عن النمو العرضي للعظم (زيادة الثخانة)"
},
{
"question": "3. ما هي وظيفة الأوتار في الجهاز الحركي؟",
"options": ["ربط العظام ببعضها وتثبيتها","✓ ربط العضلات بالعظام والمساهمة في تحريك العظام","تكوين المادة العظمية"],
"answer": "✓ ربط العضلات بالعظام والمساهمة في تحريك العظام"
},
{
"question": "4. ما هي وظيفة القفص الصدري؟",
"options": ["حماية الدماغ والنخاع الشوكي","✓ حماية القلب والرئتين","تسهيل حركة الأطراف العلوية"],
"answer": "✓ حماية القلب والرئتين"
},
{
"question": "5. ما هي وظيفة عظام القحف في الجمجمة؟",
"options": ["تسهيل عملية النطق","✓ توفير الحماية للدماغ","تثبيت الأسنان في الفكين"],
"answer": "✓ توفير الحماية للدماغ"
},
{
"question": "6. ما هي وظيفة العمود الفقري؟",
"options": ["حماية القلب والرئتين","✓ يشكل دعامة للجسم ويحمي النخاع الشوكي","تخزين المواد الغذائية"],
...
"options": ["تخزين الأملاح المعدنية","✓ تؤدي عملاً ميكانيكياً يساعد على تنفيذ الحركات المطلوبة","إنتاج السيالة العصبية المحركة"],
"answer": "✓ تؤدي عملاً ميكانيكياً يساعد على تنفيذ الحركات المطلوبة"
},
{
"question": "9. ما هي وظيفة العضلة الماصغة؟",
"options": ["تحريك الرأس يميناً ويساراً","✓ توجد على جانبي الوجه ووظيفتها إغلاق الفكين","تسهيل عملية التنفس"],
"answer": "✓ توجد على جانبي الوجه ووظيفتها إغلاق الفكين"
},
{
"question": "10. ما هي وظيفة الأربطة في المفاصل؟",
"options": ["نقل الدم إلى العظام","✓ تربط العظام ببعضها وتساعد على اتزان المفاصل وحركتها","تحويل الغضاريف إلى عظام"],
